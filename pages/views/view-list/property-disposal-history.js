/* ── Property Disposal History ───────────────── */
(function () {
  'use strict';
  window.VIEW_VIEWS = window.VIEW_VIEWS || {};

  const HOST = '_pdh_host';
  const allData = [
    { txType: 'Disposal', dispNo: 'PD-2026-00101', by: 'Juan Dela Cruz', date: '2026-04-15', status: 'Disposed',  remarks: '—',                     doc: 'DR-0101.pdf' },
    { txType: 'Disposal', dispNo: 'PD-2026-00098', by: 'Maria Santos',   date: '2026-04-08', status: 'Pending',   remarks: '—',                     doc: '—' },
    { txType: 'Disposal', dispNo: 'PD-2026-00085', by: 'Jose Reyes',     date: '2026-03-22', status: 'Cancelled', remarks: 'Duplicate entry',        doc: '—' },
    { txType: 'Disposal', dispNo: 'PD-2026-00072', by: 'Ana Gomez',      date: '2026-03-10', status: 'Disposed',  remarks: '—',                     doc: 'DR-0072.pdf' },
    { txType: 'Disposal', dispNo: 'PD-2026-00061', by: 'Pedro Lim',      date: '2026-02-28', status: 'Declined',  remarks: 'Awaiting BAC approval', doc: '—' },
    { txType: 'Disposal', dispNo: 'PD-2026-00050', by: 'Rosa Valdez',    date: '2026-02-14', status: 'Disposed',  remarks: '—',                     doc: 'DR-0050.pdf' },
    { txType: 'Disposal', dispNo: 'PD-2026-00039', by: 'Carlo Mendoza',  date: '2026-01-30', status: 'Pending',   remarks: '—',                     doc: '—' },
  ];
  ...
  window._vView = function (idx) {
    ...
    VH.viewModal({
      hostId: HOST, overlayId: '_pdh_view_ov', title: 'Disposal Record Details', headClass: 'vm-head--view',
  ...
  window._vUpload = function (idx) {
    const r = filtered[idx];
    VH.uploadModal({
      hostId: HOST, overlayId: '_pdh_upl_ov', label: r.dispNo,
  ...
  window._vCancel = function (idx) {
    _cancelIdx = idx;
    VH.cancelModal({
      hostId: HOST, overlayId: '_pdh_cancel_ov', recordId: filtered[idx].dispNo,
      onConfirm: () => {
  ...
  function onLoad() {
    ...
    if (thead) thead.innerHTML = `<tr>
      <th>DISPOSAL #</th><th>TRANSACTION TYPE</th><th>DISPOSED BY</th><th>DATE</th>
  ...
  window.VIEW_VIEWS['property-disposal-history'] = {
    label: 'Property Disposal History', group: 'Property', hasDateBar: true,
    filterFields: ['DisposalNumber', 'DisposedBy', 'Date', 'Status'],
    columns: ['Disposal #', 'Transaction Type', 'Disposed By', 'Date', 'Status', 'Decline/Cancel Remarks', 'Document', 'Action'],
    onLoad, onUnload,
  };
}());
